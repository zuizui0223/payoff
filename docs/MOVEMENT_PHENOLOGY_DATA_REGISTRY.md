...
| eBird Status and Trends | Stage-2 global bird front | Weekly products for thousands of globally modelled bird species | weekly abundance, occurrence, proportion-population | Requires eBird Status and Trends access key for full downloads. Use 27 km first for scalable pilot, then 9/3 km sensitivity. |
