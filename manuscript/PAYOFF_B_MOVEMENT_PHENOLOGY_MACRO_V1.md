...
**Target lane:** Global Ecology and Biogeography  
**Status:** integrated manuscript V1; analysis-complete for the current three-taxon phase-retention claim, pending final figure QA, systematic novelty search, and editorial compression.

## Abstract

Migrants move through environments whose seasonal timing varies across space and among years, yet phenological tracking is commonly summarized by arrival mismatch, surfing scores, or migration speed. These measures conflate two distinct processes: how predictable downstream environmental timing is and how much realized phase error is corrected during movement. We developed a common phase-retention coordinate and applied it to broad-scale and individual movement data. A reanalysis of 5,816 bird-year-cell observations from 55 migratory species did not support a universal animal-to-environment speed optimum, motivating a shift from zero-lag matching to preservation and transformation of system-specific phenological phase. Direct reconstructions in mule deer, barnacle geese across three flyways, and Eurasian wigeon all showed phase contraction over ecologically meaningful movement intervals, but with strongly heterogeneous retention (\(|\lambda|\) approximately 0.11–0.86) and different actuator architectures. Mule deer combined movement-speed and stopover adjustments, barnacle geese used stage-specific stopover control and overtaking, whereas wigeon showed weak but significant phase contraction without detectable stopover or travel-speed responses. Across barnacle-goose transitions, environmental predictability did not map monotonically onto feedback strength, supporting a decomposition of environmental innovation and behavioral phase retention. An independent industrial-development analysis further showed reduced movement control permeability in the large-development population across all registered spatial definitions, while a stronger temporal-deterioration prediction was not supported. These results suggest that phenological migration is better compared through a common phase-retention coordinate embedded within distinct information, actuation, and strategy regimes than through a universal migration rate or mismatch threshold.
