# GEB integrated tracking ecology — PREOUTCOME cover-letter overlay

**PREOUTCOME TEMPLATE — remove internal note before submission**
...
recover one portable animal-speed/environmental-wave-speed optimum. A fresh
registered chronological holdout then tests temporal substitution directly:
stronger 2002–2009 timing responsiveness does not weaken 2010–2017
...
descriptive evidence. This gain–capacity–propagation decomposition is independently consistent with
the source study: green-up date and green-up speed anomalies predict bird
migration speed, while the published species timing-sensitivity coefficient for
migration speed is not negative. Direct
...
temporal replacement**. Timing responsiveness can improve alignment, but
responsiveness is not capacity and does not make movement-speed matching
dispensable. Current mismatch is consequently not a direct measure of remaining
tracking capacity.
